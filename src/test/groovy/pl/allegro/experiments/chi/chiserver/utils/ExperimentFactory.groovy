...
class ExperimentFactory {
    ...
    static Experiment simple50to50(String id, String vA, String vB) {
        return new Experiment(id, [
                ...
                new ExperimentVariant(vB, [new HashRangePredicate(new PercentageRange(50, 100))])], null, null)
    }

    static Experiment simple50(String id, String vA) {
        return new Experiment(id, [ new ExperimentVariant(vA, [new HashRangePredicate(new PercentageRange(0, 50))])], null, null)
    }
